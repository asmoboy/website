...
(function () {
  ...
  var DICT = {
    en: {
      ...
      pp_s6h: 'Google Analytics', pp_s6p: 'With your consent, we use Google Analytics 4 (measurement ID G-2R0ZC3GZ07) to understand visits and shop interactions. Analytics remains disabled until you select “Accept all”. Google may process usage data as our analytics provider. You can withdraw consent at any time below.', pp_reset: 'Change analytics consent',
    ...
    de: {
      ...
      pp_s6h: 'Google Analytics', pp_s6p: 'Mit deiner Einwilligung verwenden wir Google Analytics 4 (Mess-ID G-2R0ZC3GZ07), um Besuche und Shop-Interaktionen auszuwerten. Analytics bleibt deaktiviert, bis du „Alle akzeptieren“ auswählst. Google kann Nutzungsdaten als unser Analysedienstleister verarbeiten. Du kannst deine Einwilligung unten jederzeit widerrufen.', pp_reset: 'Analytics-Einwilligung ändern',
    ...
    ro: {
      ...
      pp_s6h: 'Google Analytics', pp_s6p: 'Cu consimțământul tău, folosim Google Analytics 4 (ID de măsurare G-2R0ZC3GZ07) pentru a înțelege vizitele și interacțiunile din magazin. Analytics rămâne dezactivat până când alegi „Acceptă toate”. Google poate prelucra date de utilizare în calitate de furnizor de analiză. Îți poți retrage oricând consimțământul mai jos.', pp_reset: 'Modifică acordul pentru Analytics',
